...
type SessionMock struct {
	...
	UserGuildsFunc                 func(limit int, beforeID string, afterID string, withCounts bool, options ...discordgo.RequestOption) (st []*discordgo.UserGuild, err error)
}
...
func (s *SessionMock) UserGuilds(limit int, beforeID string, afterID string, withCounts bool, options ...discordgo.RequestOption) (st []*discordgo.UserGuild, err error) {
	return s.UserGuildsFunc(limit, beforeID, afterID, withCounts, options...)
}
